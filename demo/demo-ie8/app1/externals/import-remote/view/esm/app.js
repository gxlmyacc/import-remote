...
exports["default"] = exports.RemoteApp = void 0;
...
var RemoteApp = _react["default"].forwardRef(
/**
...
function (props, ref) {
  var _props$src = props.src,
      ...
      _props$exportName = props.exportName,
      exportName = _props$exportName === void 0 ? 'default' : _props$exportName,
      hoc = props.hoc,
      children = props.children,
      restProps = (0, _objectWithoutProperties2["default"])(props, ["src", "module", "moduleName", "exportName", "hoc", "children"]);
  ...
  (0, _react.useEffect)(function () {
    ...
    (src ? (0, _["default"])(src) : module.require(moduleName)).then(function (esModule) {
      var App = createAppView(esModule.__esModule ? esModule[exportName] : esModule);
      if (hoc) App = hoc(App);
      setApp({
        App: App
      });
    });
  }, [src, module, moduleName, exportName, hoc]);
  return App ? <App {...ref ? {
    ref: ref
  } : {}} {...restProps}>
        {children}
