...
function createRuntime() {
  ...
  function hotCreateRequire(moduleId) {
    ...
    for (var name in __webpack_require__) {
      if (_hasOwnProperty.call(__webpack_require__, name) && name !== 'e' && name !== 't') {
        (0, _fetch.objectDefineProperty)(fn, name, ObjectFactory(name));
      }
    }
  ...
  function hotCreateModule(moduleId) {
    var hot = {
      ...
      accept: function accept(dep, callback) {
        if (dep === undefined) hot._selfAccepted = true;else if (typeof dep === 'function') hot._selfAccepted = dep;else if ((0, _typeof2["default"])(dep) === 'object') for (var _i = 0; _i < dep.length; _i++) {
          hot._acceptedDependencies[dep[_i]] = callback || function () {};
        } else hot._acceptedDependencies[dep] = callback || function () {};
      },
      decline: function decline(dep) {
        if (dep === undefined) hot._selfDeclined = true;else if ((0, _typeof2["default"])(dep) === 'object') for (var _i2 = 0; _i2 < dep.length; _i2++) {
  ...
  __webpack_require__.d = function (exports, name, getter) {
    if (!__webpack_require__.o(exports, name)) {
      (0, _fetch.objectDefineProperty)(exports, name, {
        enumerable: true,
        get: getter
      });
    }
  ...
  __webpack_require__.t = function (value, mode) {
    ...
    (0, _fetch.objectDefineProperty)(ns, 'default', {
      enumerable: true,
      value: value
    });
