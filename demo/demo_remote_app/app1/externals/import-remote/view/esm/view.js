...
var REGX_CSS_SELECTOR = /((?:^|[\n},]|(?:"UTF\-8";(?:\/\*.*\*\/)?)|(?:\.css\);)))([^{},\s();/\\@\d][^{},\s();/\\@]*)/ig;
var REGX_CSS_FUNC_VALUE = /^url$/; // eslint-disable-next-line max-len
  ...
  (0, _createClass2["default"])(RemoteView, [{
    ...
    value: function _loadView() {
      ...
      var _this$props = this.props,
          ...
          exportName = _this$props.exportName,
          transfromHtmlBodyTagClass = _this$props.transfromHtmlBodyTagClass,
      ...
      _require({
        ...
        beforeSource: function beforeSource(source, type) {
          if (scopeStyle && (!shadow || !_utils.supportShadow || scopeStyle === 'always') && type === 'css') {
            source = source.replace(REGX_CSS_SELECTOR, function (m, p1, p2) {
              var p2LowerCase = p2 ? p2.toLowerCase() : '';
              if (REGX_CSS_FUNC_VALUE.test(p2LowerCase)) return p1 + p2;
              var isHtmlBodyEl = transfromHtmlBodyTagClass && /^(html|head|body)\b/.test(p2LowerCase);
              if (isHtmlBodyEl) p2 = ".".concat(classPrefix, "view").concat(p2LowerCase.startsWith('html') ? '' : '-' + p2LowerCase);
    ...
    value: function render() {
      ...
      var _this$props2 = this.props,
          ...
          _this$props2$bodyStyl = _this$props2.bodyStyle,
          bodyStyle = _this$props2$bodyStyl === void 0 ? {} : _this$props2$bodyStyl,
          scopePrefix = _this$props2.scopePrefix,
          transfromHtmlBodyTagClass = _this$props2.transfromHtmlBodyTagClass,
          module = _this$props2.module,
          moduleName = _this$props2.moduleName,
          exportName = _this$props2.exportName;
      var otherProps = {};
...
RemoteView.propTypes = {
  scopeStyle: _propTypes["default"].oneOfType([_propTypes["default"].bool, _propTypes["default"].oneOf(['always'])]),
  scopePrefix: _propTypes["default"].string,
  classPrefix: _propTypes["default"].string,
  className: _propTypes["default"].string,
  transfromHtmlBodyTagClass: _propTypes["default"].bool,
  ...
  exportName: _propTypes["default"].string,
